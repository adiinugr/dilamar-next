        ...
        <div className={`flex flex-col w-full items-center font-body`}>
          <Fade bottom>
            <div className="w-64 h-64 relative">
              <div className="absolute p-3 w-full h-full left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <img
                  src={imagePathWanita}
              ...
              <div className="absolute w-full h-full rounded-full left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <img
                  src="/images/frame/circle-frame.webp"
...
export default RusticCircleImage
